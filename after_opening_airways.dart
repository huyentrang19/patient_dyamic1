...
class AfterOpeningAirways extends StatefulWidget {
  AfterOpeningAirways(bool isSpontaneousBreathingPresent, {Key key, this.title})
      : super(key: key);
            ...
            SizedBox(
                ...
                child: Container(
                    child: RaisedButton(
                        ...
                        color: Colors.blue,
                        onPressed: () {
                          categoryT1A.isAfterOpeningAirways = true;
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) =>
                                      CameraAccess(categoryT1A)));
                        }))),
            SizedBox(
              height: 10,
            ),
            SizedBox(
                ...
                child: Container(
                    child: RaisedButton(
                        ...
                        color: Colors.blue,
                        onPressed: () {
                          categoryT4.isAfterOpeningAirways = false;
                          Navigator.push(
                            context,
                            MaterialPageRoute(
