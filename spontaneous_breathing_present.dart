...
class _SpontaneousBreathingPresentState
   ...
   Category get category => new Category(false, null);
            ...
            SizedBox(
                ...
                child: Container(
                    child: RaisedButton(
                        ...
                        onPressed: () {
                          setState(() {
                            category.isSpontaneousBreathingPresent = true;
                          });
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>
                                    BreathingFrequencyPerMinute(category
                                        .isSpontaneousBreathingPresent = true)),
                          );
                        }))),
            SizedBox(
              height: 10,
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => AfterOpeningAirways(
                                    category
                                        .isSpontaneousBreathingPresent = false)),
